  ...
  function (e, t, n) {
    ...
    const K = (e) => (e, t, n) => {
        ...
        const s = (t) => (n, r) => {
          ...
          c = Object.keys(i).reduce(s(i), o),
          l = Object.keys(u).reduce(s(u), []);
        return (
    ...
    const X = (e) =>
        e.fields.reduce((e, t) => {
          const n = C(t.type);
          return n.name.startsWith('_')
            ? e
            : n.kind !== Q.TypeKind.OBJECT && n.kind !== Q.TypeKind.INTERFACE
            ? [...e, $.field($.name(t.name))]
            : e;
        }, []),
      Z = (e) => {
      ...
      re = (e, t, n, r, i) => (e, o, a, u, s) => {
        const { sortField: c, sortOrder: l, ...f } = u,
          p = i(a, u),
          d = r(a, u),
          y = n(a, f, o),
          v = t(e.type, o);
    ...
    t.default = (e, t = {}, n = q, r = Y) => {
      ...
      return L(a()({}, oe, { buildQuery: o }, e)).then((e) => (t, n, r) =>
        e(t, n, r)
      );
    };
  },
